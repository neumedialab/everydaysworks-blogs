...
const BERLIN_PROFILE: Record<LanguageCode, { intro: string; title: string; paragraphs: string[] }> = {
  tr: { intro: "Eralp, göçmen kökenli bir siyasetçi olarak Berlin’de bir ilke imza atmayı amaçlıyordu ve şimdilik bunu başarmış görünüyor. Partisinin oylarını Berlin’de rekor düzeyde artıran Eralp’in liderlik koltuğuna oturup oturmayacağı, önümüzdeki haftalarda yapılacak koalisyon pazarlıklarına bağlı.", title: "Elif Eralp kimdir?", paragraphs: ["Başkent Berlin hem eyalet hem de şehir statüsünde olduğu için göreve gelen kişi hem eyalet başbakanı hem de kentin belediye başkanı olur. Bu nedenle bu makam, diğer belediye başkanları ve eyalet başbakanlarından farklı olarak Hükümet Eden Belediye Başkanı olarak tanımlanır.", "Eralp, koalisyon pazarlıkları Sol Parti lehine sonuçlanırsa hem kadın hem de göçmen olarak bu göreve gelen ilk başkan olacak.", "Elif Eralp, 1981’de Almanya’nın Münih kentinde doğdu. Sosyalist ve sendikacı ailesi, 12 Eylül 1980 darbesinden sonra Türkiye’den ayrılarak Almanya’ya sığındı; annesi o sırada sekiz aylık hamile olan bir meslek öğretmeniydi. Üç kişilik aile, iltica başvurularının onaylanmasını beklerken tek bir odada yaşadı. Daha sonra babasının doktor olarak çalıştığı Dortmund’a, Eralp sekiz yaşındayken de Hamburg’a taşındılar.", "Eralp, ailesinin Almanya’da siyasi faaliyetlerini sürdürdüğünü ve kendisini pek çok gösteriye yanlarında götürdüklerini anlatıyor. Ailesinin hikâyesi ve dünya görüşü, onun kariyer ve siyaset yolculuğunun ilk ilham kaynağı olmuş. “Sığınmacı bir anne babanın çocuğu olarak düşünebildiğim zamandan bu yana adaletsizliğe karşı mücadele ettim” diyen Eralp, kendi ailesi gibi ailelerin Almanya’da farklı muamele gördüğünü fark etmenin kendisini hukuk okumaya teşvik ettiğini belirtiyor. Daha 12 yaşındayken insan hakları avukatı olmaya karar verdiğini söyleyen Eralp, hukuk eğitimini Hamburg’da tamamladı.", "2010 yılında Berlin’e taşınan Eralp, evli ve iki çocuk annesi. “Berlinlilerin çoğu gibi” kirada yaşadıklarını ve çocuklarının “normal” bir okula gittiğini ifade ediyor. Türkçe ve Almanca’nın yanı sıra İspanyolca ve İngilizce biliyor."] },
  en: { intro: "As a politician from a migrant background, Eralp wanted to make history in Berlin and for now appears to have done so. Having taken Die Linke’s vote share to a record level in Berlin, whether she will take the city’s leadership depends on coalition negotiations in the coming weeks.", title: "Who is Elif Eralp?", paragraphs: ["Berlin is both a federal state and a city, so the officeholder is simultaneously head of the state and mayor of the city. This is why the office is formally called the Governing Mayor, unlike other mayors and state premiers.", "If the coalition talks favour Die Linke, Eralp would become the first woman and first person from a migrant background to hold the office.", "Elif Eralp was born in Munich in 1981. Her socialist and trade-unionist parents left Turkey and sought asylum in Germany after the 12 September 1980 coup; her mother, a vocational teacher, was eight months pregnant at the time. The family lived in one room while waiting for their asylum applications to be approved. They later moved to Dortmund, where her father worked as a doctor, and to Hamburg when Eralp was eight.", "Eralp says her family continued its political activity in Germany and took her to many demonstrations. She describes their story and worldview as the first inspiration for her career and political path. Saying that she had fought injustice since she was able to think as the child of asylum-seeking parents, she says seeing families like hers treated differently encouraged her to study law. She decided at the age of twelve to become a human-rights lawyer and completed her law studies in Hamburg.", "Eralp moved to Berlin in 2010. She is married and has two children. She says they rent their home, like many Berliners, and that her children attend a normal school. In addition to Turkish and German, she speaks Spanish and English."] },
  de: { intro: "Als Politikerin mit Einwanderungsgeschichte wollte Eralp in Berlin Geschichte schreiben – vorerst scheint ihr das gelungen zu sein. Ob sie nach dem Rekordergebnis der Linken die Führung der Stadt übernehmen kann, hängt von den Koalitionsverhandlungen der kommenden Wochen ab.", title: "Wer ist Elif Eralp?", paragraphs: ["Berlin ist zugleich Bundesland und Stadt. Die Amtsinhaberin ist daher sowohl Regierungschefin des Landes als auch Bürgermeisterin der Stadt. Deshalb heißt das Amt – anders als bei anderen Bürgermeistern und Ministerpräsidenten – Regierende Bürgermeisterin.", "Sollten die Koalitionsverhandlungen zugunsten der Linken ausgehen, wäre Eralp die erste Frau und die erste Person mit Einwanderungsgeschichte in diesem Amt.", "Elif Eralp wurde 1981 in München geboren. Ihre sozialistische und gewerkschaftlich engagierte Familie verließ die Türkei nach dem Militärputsch vom 12. September 1980 und suchte in Deutschland Asyl. Ihre Mutter, eine Berufsschullehrerin, war damals im achten Monat schwanger. Während des Asylverfahrens lebte die dreiköpfige Familie in einem einzigen Zimmer. Später zog sie nach Dortmund, wo ihr Vater als Arzt arbeitete, und nach Hamburg, als Eralp acht Jahre alt war.", "Eralp berichtet, dass ihre Familie auch in Deutschland politisch aktiv blieb und sie zu vielen Demonstrationen mitnahm. Die Familiengeschichte und das politische Weltbild seien die erste Inspiration für ihren beruflichen und politischen Weg gewesen. Sie habe als Kind von Menschen, die Asyl suchten, schon früh gegen Ungerechtigkeit kämpfen wollen. Als sie bemerkte, dass Familien wie ihre in Deutschland unterschiedlich behandelt wurden, habe sie sich für ein Jurastudium entschieden. Mit zwölf Jahren beschloss sie, Menschenrechtsanwältin zu werden; ihr Jurastudium absolvierte sie in Hamburg.", "2010 zog Eralp nach Berlin. Sie ist verheiratet und Mutter von zwei Kindern. Wie viele Berlinerinnen und Berliner lebe ihre Familie zur Miete; ihre Kinder besuchten eine normale Schule. Neben Türkisch und Deutsch spricht sie Spanisch und Englisch."] },
  fr: { intro: "En tant que femme politique issue de l’immigration, Eralp voulait marquer l’histoire à Berlin et semble, pour l’instant, y être parvenue. Après avoir porté le score de Die Linke à un niveau record dans la capitale, son accession à la tête de la ville dépendra des négociations de coalition des prochaines semaines.", title: "Qui est Elif Eralp ?", paragraphs: ["Berlin est à la fois un Land et une ville : la personne élue dirige donc le Land et la municipalité. C’est pourquoi la fonction est officiellement appelée maire-gouverneure, à la différence des autres maires et présidents de Land.", "Si les négociations de coalition aboutissent en faveur de Die Linke, Eralp deviendrait la première femme et la première personne issue de l’immigration à occuper cette fonction.", "Elif Eralp est née à Munich en 1981. Sa famille, socialiste et engagée dans le mouvement syndical, a quitté la Turquie après le coup d’État du 12 septembre 1980 et a demandé l’asile en Allemagne. Sa mère, enseignante dans une école professionnelle, était alors enceinte de huit mois. En attendant la décision sur leur demande, la famille de trois personnes a vécu dans une seule pièce. Elle a ensuite déménagé à Dortmund, où son père travaillait comme médecin, puis à Hambourg lorsque Eralp avait huit ans.", "Eralp raconte que sa famille a poursuivi ses activités politiques en Allemagne et l’emmenait à de nombreuses manifestations. Leur histoire et leur vision du monde ont été sa première source d’inspiration. Elle explique avoir lutté contre l’injustice depuis qu’elle pouvait penser, en tant qu’enfant de parents demandeurs d’asile, et avoir été poussée vers le droit en constatant que les familles comme la sienne étaient traitées différemment. À douze ans, elle a décidé de devenir avocate des droits humains et a étudié le droit à Hambourg.", "Installée à Berlin en 2010, Eralp est mariée et mère de deux enfants. Elle dit vivre en location, comme beaucoup de Berlinois, et envoyer ses enfants dans une école ordinaire. Elle parle turc et allemand, ainsi qu’espagnol et anglais."] },
};
      ...
      <main id="top">
        ...
        <section className="container content-layout" id="berlin">
          <article className="article-column">
            ...
            <div className="quote-panel victory-quote"><span className="quote-mark">“</span><p>{berlin.quote}<span className="quote-mark-end">”</span></p><small>Elif Eralp · {language === "tr" ? "DW aktarımı" : language === "de" ? "nach Angaben der DW" : language === "fr" ? "selon la DW" : "as reported by DW"}</small></div>
            ...
            <div className="embedded-video"><div className="embedded-video-head"><span>SEÇİM GECESİ · İZLE</span><a href="https://www.youtube.com/watch?v=ZJfyL_N-ees" target="_blank" rel="noreferrer">Orijinal video <ArrowUpRight size={14} /></a></div><iframe src="https://www.youtube.com/embed/ZJfyL_N-ees?rel=0" title="Berlin seçim gecesi: Elif Eralp ve Die Linke kutlamaları" loading="lazy" referrerPolicy="strict-origin-when-cross-origin" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen /><a className="video-fallback" href="https://www.youtube.com/watch?v=ZJfyL_N-ees" target="_blank" rel="noreferrer">Video açılmazsa YouTube’da izleyin <ArrowUpRight size={14} /></a></div>
            ...
            <p className="profile-intro">{BERLIN_PROFILE[language].intro}</p>
            <h3 className="profile-heading">{BERLIN_PROFILE[language].title}</h3>
            {BERLIN_PROFILE[language].paragraphs.map((paragraph) => <p key={paragraph}>{paragraph}</p>)}
            <p>{berlin.p2}</p><p>{berlin.p3}</p><p>{berlin.p4}</p>
