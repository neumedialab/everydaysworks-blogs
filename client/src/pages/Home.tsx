      ...
      <main id="top">
        ...
        <section className="container content-layout" id="berlin">
          <article className="article-column">
            ...
            <details className="speech-transcript"><summary>{berlin.transcript}</summary><p className="speech-german"><em>Liebe, liebes Berlin, liebe Berlinerinnen, liebe Berliner. In unserer Stadt hat die Liebe und die Gerechtigkeit über den Hass gewonnen. Das haben wir heute alle gemeinsam gezeigt und dieses Signal geht raus in die Welt.</em></p><p>{berlin.translation}</p><p>{berlin.thanks}</p><small>Seçim gecesi video kaydı · Almanca özgün bölüm ve seçilen dilde çeviri</small></details>
            <div className="law-card">
